          ...
          <div className='grid services'>
            <div className='col-5 service-grid'>
              ...
              <div className='service'>
                <p>You submit a video and text-based creative brief describing the campaign you’d like to run, who you’re targeting and what its goals are.</p>
              </div>
              <div className='service'>
